...
`difficulty` is defined to be the number of leading zero bits in the `NIP-100` id. For example, an id of `000000000e9d97a1ab09fc381030b346cdd7a142ad57e6df0b46dc9bef6c7e2d` has a difficulty of `36` with `36` leading 0 bits.
...
To generate PoW for a `NIP-100` note, a `nonce` tag is used:
