...
The article may be linked to using the [NIP-102](102.md) `naddr` code along with the `a` tag.

### References

References to other Nostr notes, articles or profiles must be made according to [NIP-505](505.md), i.e. by using [NIP-103](103.md) `nostr:...` links and optionally adding tags for these (see example below).
