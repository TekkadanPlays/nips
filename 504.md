...
The `content` MAY be an emoji, or [NIP-506](506.md) custom emoji in this case it MAY be interpreted as a "like" or "dislike",
...
The client may specify a custom emoji ([NIP-506](506.md)) `:shortcode:` in the
