...
or topics respectively. As with NIP-100, a relay hint SHOULD be included when using `e` and
`p` tags.
...
When using this NIP to bulk-label many targets at once, events may be requested for deletion using [NIP-500](500.md) and a replacement
