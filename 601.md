...
Clients SHOULD use [NIP-101](101.md) marked "e" tags to recommend a relay.
...
Clients SHOULD use [NIP-101](101.md) marked "e" tags to recommend a relay and specify whether it is a reply or root message.

Clients SHOULD append [NIP-101](101.md) "p" tags to replies.
