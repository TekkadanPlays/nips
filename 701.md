...
## Theory of Operation
 1. **Users** who wish to use this NIP to send lightning payments to other nostr users must first acquire a special "connection" URI from their NIP-701 compliant wallet application.  The wallet application may provide this URI using a QR screen, or a pasteable string, or some other means. 
...
- `NIP-701 info event`: 13194
- `NIP-701 request`: 23194
- `NIP-701 response`: 23195
...
The content of requests and responses is encrypted with [NIP04](699.md), and is a JSON-RPCish object with a semi-fixed structure:
