...
Kind `82`s SHOULD be [gift wrapped](405.md) using `kind:1059` to each receiving user for the best privacy.

Kind `82` can also be included inside [NIP-600](600.md) DMs via [nembed](https://github.com/nostr-protocol/nips/pull/1078) events. 
