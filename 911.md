...
Service Providers MAY use NIP-910 announcements to advertise their support for job kinds:
...
Customers can use NIP-910 to see what service providers their follows use.
